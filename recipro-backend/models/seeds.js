const seeds = [
    ...
    {
        recipeName: "Spaghetti with red sauce",
        ingredients: ["spaghetti", "tomatoes", "garlic", "basil", "onion"],
        prepMinutes: 30,
        difficultyLevel: 2,
        recipeTags: ["vegetarian", "pasta", "Italian"]
    },
    {
        recipeName: "Summer panzanella",
        ingredients: ["bread", "tomatoes", "onion", "balsamic vinegar", "olive oil", "basil"],
        prepMinutes: 10,
        difficultyLevel: 1,
